  ...
  return (
    <div className="space-y-8">
      <section className="text-center py-12 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-lg shadow-xl">
        ...
        <a href="/servicos" className="bg-white text-indigo-600 font-semibold py-3 px-8 rounded-lg hover:bg-gray-100 transition duration-300 text-lg shadow-md">
          Conheça Nossas Soluções
        </a>
      </section>

      <section className="py-10">
        <h2 className="text-3xl font-semibold text-gray-800 mb-6 text-center">Por que Automatizar com a Duma Tech?</h2>
        <div className="grid md:grid-cols-3 gap-8 text-center">
          <div className="p-6 bg-white rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
            <h3 className="text-2xl font-semibold text-blue-600 mb-3">Eficiência Operacional</h3>
          ...
          <div className="p-6 bg-white rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
            <h3 className="text-2xl font-semibold text-blue-600 mb-3">Redução de Custos</h3>
            <p className="text-gray-600">
          ...
          <div className="p-6 bg-white rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
            <h3 className="text-2xl font-semibold text-blue-600 mb-3">Escalabilidade e Inovação</h3>
            <p className="text-gray-600">
      ...
      <section className="py-10 bg-gray-50 rounded-lg shadow-inner">
        ...
        <div className="text-center">
            <a href="/servicos" className="bg-blue-600 text-white font-semibold py-3 px-8 rounded-lg hover:bg-blue-700 transition duration-300 text-lg shadow-md">
