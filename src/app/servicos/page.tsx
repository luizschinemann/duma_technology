  ...
  return (
    <div className="space-y-8 py-10">
      ...
      <section className="p-8">
        ...
        <p className="text-gray-700 leading-relaxed">
          Nossos especialistas desenvolvem Lambdas para uma variedade de aplicações, como processamento de dados em tempo real, backends para aplicações móveis e web, automação de tarefas de TI, e integrações complexas entre diferentes sistemas. Seja para processar uploads de arquivos, interagir com bancos de dados, ou executar lógica de negócios complexa, as funções serverless oferecem uma maneira eficiente e moderna de construir aplicações robustas e responsivas. A Duma Tech garante que suas funções sejam otimizadas para performance, segurança e custo-benefício.
        </p>
      </section>
      ...
      <section className="bg-gray-50 p-8 rounded-lg shadow-md">
        ...
        <p className="text-gray-700 leading-relaxed">
          Nossas soluções de RPA são aplicáveis a uma vasta gama de setores e processos, incluindo finanças, recursos humanos, atendimento ao cliente e operações de TI. Desde a reconciliação de dados financeiros, processamento de faturas, onboarding de novos funcionários, até a migração de dados entre sistemas legados e modernos, o RPA pode trazer ganhos expressivos de produtividade, precisão e conformidade. A Duma Tech trabalha com as principais plataformas de RPA do mercado para entregar a solução mais adequada às suas necessidades, garantindo um retorno sobre o investimento rápido e sustentável.
        </p>
      </section>
      ...
      <section className="p-8">
        ...
        <p className="text-gray-700 leading-relaxed">
          Seja para conectar seu CRM ao seu sistema de ERP, sua plataforma de e-commerce aos seus sistemas de logística, ou integrar ferramentas de marketing com suas bases de dados de clientes, nossas soluções de integração eliminam silos de informação e automatizam fluxos de trabalho que dependem de múltiplos sistemas. Isso resulta em processos mais ágeis, dados mais consistentes e uma visão unificada do seu negócio, capacitando decisões mais informadas e estratégicas.
        </p>
      </section>
    </div>
  );
