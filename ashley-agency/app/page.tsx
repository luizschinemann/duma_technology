                ...
                <div className="container">
                  <div className="mil-banner-content mil-up">
                    ...
                    <div className="mil-circle-text">
                      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 300 300" style={{ enableBackground: 'new 0 0 300 300' }} xmlSpace="preserve" className="mil-ct-svg mil-rotate" data-value="360">
                        <defs>
            ...
            <div className="mil-soft-bg">
              <div className="container mil-p-0-120">
                ...
                <div className="swiper-container mil-infinite-show mil-up">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <a href="#." className="mil-partner-frame" style={{ width: '60px' }}><img src="/img/partners/1.svg" alt="logo" /></a>
                    </div>
                    <div className="swiper-slide">
                      <a href="#." className="mil-partner-frame" style={{ width: '100px' }}><img src="/img/partners/2.svg" alt="logo" /></a>
                    </div>
                    <div className="swiper-slide">
                      <a href="#." className="mil-partner-frame" style={{ width: '60px' }}><img src="/img/partners/1.svg" alt="logo" /></a>
                    </div>
